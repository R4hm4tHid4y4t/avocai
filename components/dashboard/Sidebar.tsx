...
export default function Sidebar() {
  ...
  const isActive = (href: string) => {
    // Solusi: Mencegah error crash jika pathname bernilai null saat inisialisasi di Vercel
    ...
    <aside className="w-60 flex-shrink-0 bg-[#111811] flex flex-col h-full">
      ...
      <div className="p-4 border-t border-[#1e2e1e]">
        <div className="flex items-center gap-2.5">
          ...
          <Link href="/dashboard/profile" className="text-[#6b7a6b] hover:text-white transition-colors">
