      ...
      <div className="bg-[#111811] text-white rounded-xl p-6 mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">Diperbarui 19 Mei 2025 • Berikutnya 19 Jun 2025</p>
          </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={inv.period} className="flex items-center justify-between py-2.5 border-b border-gray-50 last:border-0">
              <div>
                <p className="text-sm font-medium text-gray-700">{inv.period}</p>
                <p className="text-xs text-gray-400">{inv.amount}</p>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">{inv.status}</span>
                <button className="text-xs text-gray-400 hover:text-gray-600">Unduh PDF</button>
              </div>
            </div>
          ))}
        </div>
